...
/**
 * 动态圈用的时间  刚刚、几分钟前、几小时前、昨天 14:00   2018-07-01
 */
...
/**
 * 会话页面专用  14:20 、昨天 14:00 、星期二 14：20 、 2018-07-01
 */
...
- (NSString *)formattedDateDescriptionSeconds; //将long转换为NSString;

+ (NSDate *)dateWithTimeIntervalInMilliSecondSince1970:(double)timeIntervalInMilliSecond;



- (BOOL)judgeDayOrNight;//YES 白天 NO 黑夜 判断白天还是黑夜
